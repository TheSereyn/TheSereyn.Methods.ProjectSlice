...
- either a visible handoff to `psm-project-manager` or a user-visible fallback when handoff is unavailable.
...
8. If the current surface cannot hand off, use the documented user-visible fallback and make the loss of persistent project-local context explicit.
